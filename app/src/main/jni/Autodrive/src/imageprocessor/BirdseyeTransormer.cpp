...
optional<cv::Mat> BirdseyeTransformer::find_perspective(cv::Mat* matIn, double thresh1 = 300, double thresh2 = 150) {
...
lanes BirdseyeTransformer::getLaneMarkings(const cv::Mat& canniedMat,cv::Mat* drawMat) {
	lanes lanes;
