// Copied from https://github.com/oreillymedia/Learning-OpenCV-3_examples
// Print out the calibration matrix for this camera to undistort images.
...
void help(const char **argv) {
    cout << "\n\n"
         ...
         << " Note: image_scaling_factor should be 1 if the saved images are the same\n"
         << " resolution as the intended use.\n"
         << endl;
}
